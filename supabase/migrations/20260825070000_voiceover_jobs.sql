...
alter table public.voiceover_jobs
  add column if not exists job_type text not null default 'instant_voiceover',
  add column if not exists text text,
  add column if not exists mode text not null default 'bed',
